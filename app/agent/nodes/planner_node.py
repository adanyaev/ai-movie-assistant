...
MovieReviewsSummarizer - агент по названию фильма находит самые релевантые отзывы и возвращает их суммаризицацию.
Используй этого агента, когда пользователь хочет узнать мнение других людей о фильме.
В качестве вопроса для агента передай только название фильма, без лишней информации!
